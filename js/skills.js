...
(function() {
  var graph, i, len, ref, removeXLabel, skill;

  removeXLabel = function(chart) {
    return chart.svg().append('text').attr('class', 'x-axis-label').attr('text-anchor', 'middle').attr('x', chart.width()).attr('y', chart.height()).text('');
  };

  graph = function(skill) {
